...
Board::Board()
{
    ...
    drives[24]=new int[5]{37,9,27,43,-1};
    drives[25]=new int[6]{33,23,35,0,39,-1};
    drives[26]=new int[6]{13,44,43,12,37,-1};
    ...
    drives[37]=new int[5]{24,9,46,26,-1};
